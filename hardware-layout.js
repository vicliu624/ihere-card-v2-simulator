...
(() => {
  ...
  const parts = Object.freeze([
    ...
    { selector: '.key-menu', x: 9.5, y: 6.5, width: 8, height: 6 },
  ...
  window.IHereHardwareLayout = Object.freeze({ revision: 'REV 08 + MENU/MUTE with wheel confirmations', board, parts, apply });
